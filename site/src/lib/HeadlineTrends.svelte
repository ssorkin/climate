<script>
   ...
   * after the wave ends, and overnight relief — plus days per heat wave, kept so the reader
   * sees that the events have not gotten longer — each with a 95% interval from a
