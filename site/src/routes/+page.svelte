<script>
  /**
   * The front page tells one story: at LA-area stations, heat waves still peak at about
   * the same temperature, but the nights inside them no longer cool down. Everything else
   * the site computes lives in /explore, /stations and the station pages.
   */
...
{#if hwHero && hwCompare.length}
  <section class="hero">
    <div class="text">
      <h1>Los Angeles heat waves aren't getting much hotter at their peak. But the nights aren't cooling down.</h1>
      <p class="lede">
      ...
      <p class="small attribution">
        ...
        Readings through {fmtISO(latest)}.
      </p>
    </div>
  </section>
