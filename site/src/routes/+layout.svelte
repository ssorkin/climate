...
<div class="shell" class:wide={page.url.pathname === '/' || page.url.pathname.startsWith('/stories') || page.url.pathname.startsWith('/explore') || page.url.pathname.startsWith('/stations') || page.url.pathname.startsWith('/us')}>
  <header>
